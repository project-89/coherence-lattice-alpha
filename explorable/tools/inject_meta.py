...
# ---------------------------------------------------------------------------
BASE_URL    = "https://project-89.github.io/coherence-lattice-alpha"
SITE_NAME   = "The Living Lattice"
SITE_AUTHOR = "Michael Sharpe"
TWITTER     = ""   # e.g. "@your_handle" — leave blank to omit

# Paste the analytics provider snippet here (Plausible/GoatCounter/etc).
# Anything between the <!-- begin --> and <!-- end --> markers gets injected.
ANALYTICS_SNIPPET = ""
