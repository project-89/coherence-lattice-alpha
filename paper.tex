...
Equation~\eqref{eq:ascent} is intended as the central principle of a broader substrate-agnostic coherence-lattice framework, presented in a forthcoming companion paper~\cite{Sharpe2026Coherence}. The present paper is one specific application of this principle---to the phase sector of the 3D diamond lattice, at its BKT critical point---and all arguments in what follows are self-contained; no claim in this paper depends on the companion work.
\end{remark}
